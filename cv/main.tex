...
I am interested in researching mathematical foundations and developing modern algorithms for the autonomous navigation of self-driving cars and dynamic robots, achieving low-latency, agile, and safe maneuvers with adaptation and robustness in complex environments. My research lies in the combination of control, optimization, motion planning, trajectory generation, reinforcement learning, and machine learning.
...
\section{Experience}
    \resumeSubHeadingListStart
        ...
        \resumeItemListStart
            ...
            \resumeItem{Full-Stack Robotics \& Large Behavior Models: Built full-stack robotics expertise across trajectory generation, motion planning, and control, together with end-to-end large behavior model experience spanning pretraining, post-training, evaluation harness, and deployment.}
        \resumeItemListEnd
